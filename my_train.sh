...
./distributed_train.sh 6 /root/autodl-tmp/imagenet --model twins_pcpvt_small_spike_v \
...
# python train.py /root/autodl-tmp/imagenet --model twins_pcpvt_small_spike_v \
# --sched cosine --epochs 300 --warmup-epochs 5 --lr 0.0015 --opt AdamW --weight-decay 0.05 \
